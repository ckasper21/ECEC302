...
HD_PWD='E:/ECE-C302/Quiz/state_machine_7seg/state_machine_7seg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log state_machine_7seg.vdi -applog -m64 -messageDb vivado.pb -mode batch -source state_machine_7seg.tcl -notrace
