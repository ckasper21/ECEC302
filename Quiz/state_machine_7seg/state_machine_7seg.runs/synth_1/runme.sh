...
HD_PWD='E:/ECE-C302/Quiz/state_machine_7seg/state_machine_7seg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log state_machine_7seg.vds -m64 -mode batch -messageDb vivado.pb -notrace -source state_machine_7seg.tcl
