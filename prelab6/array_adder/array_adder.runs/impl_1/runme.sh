...
HD_PWD='D:/ECE-C302/prelab6/array_adder/array_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log array_adder.vdi -applog -m64 -messageDb vivado.pb -mode batch -source array_adder.tcl -notrace
