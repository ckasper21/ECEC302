...
HD_PWD='D:/ECE-C302/prelab6/array_adder/array_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log array_adder.vds -m64 -mode batch -messageDb vivado.pb -notrace -source array_adder.tcl
