...
HD_PWD='D:/ECE-C302/prelab6/serial_adder/serial_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log serial_adder.vdi -applog -m64 -messageDb vivado.pb -mode batch -source serial_adder.tcl -notrace
