...
HD_PWD='D:/ECE-C302/prelab6/serial_adder/serial_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log serial_adder.vds -m64 -mode batch -messageDb vivado.pb -notrace -source serial_adder.tcl
