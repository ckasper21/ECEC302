...
HD_PWD='E:/ECE-C302/Midterm/mult_unsigned/mult_unsigned.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log unsigned_mult.vds -m64 -mode batch -messageDb vivado.pb -notrace -source unsigned_mult.tcl
