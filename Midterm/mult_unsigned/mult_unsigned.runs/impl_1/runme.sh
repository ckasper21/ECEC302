...
HD_PWD='E:/ECE-C302/Midterm/mult_unsigned/mult_unsigned.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log unsigned_mult.vdi -applog -m64 -messageDb vivado.pb -mode batch -source unsigned_mult.tcl -notrace
