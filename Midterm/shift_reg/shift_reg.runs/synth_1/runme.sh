...
HD_PWD='E:/ECE-C302/Midterm/shift_reg/shift_reg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_reg5.vds -m64 -mode batch -messageDb vivado.pb -notrace -source shift_reg5.tcl
