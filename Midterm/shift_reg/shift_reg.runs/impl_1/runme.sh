...
HD_PWD='E:/ECE-C302/Midterm/shift_reg/shift_reg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_reg5.vdi -applog -m64 -messageDb vivado.pb -mode batch -source shift_reg5.tcl -notrace
