...
HD_PWD='E:/ECE-C302/lab7/array_multiplier/array_multiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log array_multiplier.vdi -applog -m64 -messageDb vivado.pb -mode batch -source array_multiplier.tcl -notrace
