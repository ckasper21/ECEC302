...
HD_PWD='E:/ECE-C302/lab7/array_multiplier/array_multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log array_multiplier.vds -m64 -mode batch -messageDb vivado.pb -notrace -source array_multiplier.tcl
