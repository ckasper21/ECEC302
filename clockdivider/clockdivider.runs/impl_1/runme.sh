...
HD_PWD='C:/Users/cdc75/clockdivider.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clockdivider.vdi -applog -m64 -messageDb vivado.pb -mode batch -source clockdivider.tcl -notrace
