...
HD_PWD='E:/ECE-C302/prelab3/serial_adder/serial_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_serial_adder.vdi -applog -m64 -messageDb vivado.pb -mode batch -source test_serial_adder.tcl -notrace
