...
HD_PWD='E:/ECE-C302/prelab3/serial_adder/serial_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_serial_adder.vds -m64 -mode batch -messageDb vivado.pb -notrace -source test_serial_adder.tcl
