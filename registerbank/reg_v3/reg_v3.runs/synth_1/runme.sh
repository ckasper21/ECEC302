...
HD_PWD='C:/Users/cdc75/Desktop/registerbank/reg_v3/reg_v3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reg_v3.vds -m64 -mode batch -messageDb vivado.pb -notrace -source reg_v3.tcl
