...
HD_PWD='E:/ECE-C302/registerbank/reg_v4/reg_v4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log reg_v4.vdi -applog -m64 -messageDb vivado.pb -mode batch -source reg_v4.tcl -notrace
