...
HD_PWD='C:/Users/cdc75/Desktop/Lab/hw1/unsignedmult/unsignedmult.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log unsignedmult.vdi -applog -m64 -messageDb vivado.pb -mode batch -source unsignedmult.tcl -notrace
