...
HD_PWD='C:/Users/cdc75/Desktop/Lab/hw1/unsignedmult/unsignedmult.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log unsignedmult.vds -m64 -mode batch -messageDb vivado.pb -notrace -source unsignedmult.tcl
