...
HD_PWD='E:/ECE-C302/hw1/signedmult/signedmult/signedmult.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log signedmult.vds -m64 -mode batch -messageDb vivado.pb -notrace -source signedmult.tcl
