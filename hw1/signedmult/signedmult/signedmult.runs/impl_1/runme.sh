...
HD_PWD='E:/ECE-C302/hw1/signedmult/signedmult/signedmult.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log signedmult.vdi -applog -m64 -messageDb vivado.pb -mode batch -source signedmult.tcl -notrace
