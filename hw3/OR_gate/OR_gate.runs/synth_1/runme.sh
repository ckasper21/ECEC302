...
HD_PWD='D:/ECE-C302/hw3/OR_gate/OR_gate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OR_gate_test.vds -m64 -mode batch -messageDb vivado.pb -notrace -source OR_gate_test.tcl
