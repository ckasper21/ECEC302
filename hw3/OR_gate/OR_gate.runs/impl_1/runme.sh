...
HD_PWD='D:/ECE-C302/hw3/OR_gate/OR_gate.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OR_gate_test.vdi -applog -m64 -messageDb vivado.pb -mode batch -source OR_gate_test.tcl -notrace
