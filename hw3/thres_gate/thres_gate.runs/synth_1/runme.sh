...
HD_PWD='D:/ECE-C302/hw3/thres_gate/thres_gate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log thres_test.vds -m64 -mode batch -messageDb vivado.pb -notrace -source thres_test.tcl
