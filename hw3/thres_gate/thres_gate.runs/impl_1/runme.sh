...
HD_PWD='D:/ECE-C302/hw3/thres_gate/thres_gate.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log thres_test.vdi -applog -m64 -messageDb vivado.pb -mode batch -source thres_test.tcl -notrace
