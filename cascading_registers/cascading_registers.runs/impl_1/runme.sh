...
HD_PWD='C:/Users/cdc75/Desktop/cascading_registers/cascading_registers.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cascade_reg4.vdi -applog -m64 -messageDb vivado.pb -mode batch -source cascade_reg4.tcl -notrace
