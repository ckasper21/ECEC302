...
HD_PWD='C:/Users/cdc75/Desktop/cascading_registers/cascading_registers.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cascade_reg4.vds -m64 -mode batch -messageDb vivado.pb -notrace -source cascade_reg4.tcl
