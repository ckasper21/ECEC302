...
HD_PWD='C:/Users/cdc75/Desktop/running_led/running_led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log run_led.vdi -applog -m64 -messageDb vivado.pb -mode batch -source run_led.tcl -notrace
