...
HD_PWD='C:/Users/cdc75/Desktop/running_led/running_led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log run_led.vds -m64 -mode batch -messageDb vivado.pb -notrace -source run_led.tcl
