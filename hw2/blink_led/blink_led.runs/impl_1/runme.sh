...
HD_PWD='C:/Users/cdc75/Desktop/blink_led/blink_led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log blink.vdi -applog -m64 -messageDb vivado.pb -mode batch -source blink.tcl -notrace
