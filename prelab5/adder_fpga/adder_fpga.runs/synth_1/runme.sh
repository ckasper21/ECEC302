...
HD_PWD='D:/ECE-C302/prelab5/adder_fpga/adder_fpga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_adder.vds -m64 -mode batch -messageDb vivado.pb -notrace -source test_adder.tcl
