...
HD_PWD='E:/ECE-C302/prelab5/adder_fpga/adder_fpga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_adder.vdi -applog -m64 -messageDb vivado.pb -mode batch -source test_adder.tcl -notrace
